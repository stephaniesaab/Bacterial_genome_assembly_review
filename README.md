...
A sample representation of the aligned reads in contig 2 with the reference genome are shown in IGV visualization in *Figure 1*, highlighting the adequate coverage of the assembly against the reference genome. IGV highlights the efficacy and accuracy of the assembly as it shows the raw reads aligned in the assembly *******
